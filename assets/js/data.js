    ...
    teachers: {
      ...
      Huang: { id:"Huang", name:"黄礼泊", title:"助理研究员", bio:"研究方向：机器学习；神经科学。", photo:"assets/img/hlb.webp", research: [
          ...
          },
          {
            heading: "主要论著",
            items: [
              "Libo Huang, Lu Gan, Yan Zeng, and Bingo Wing-Kuen Ling*. Automatical spike sorting with low-rank and sparse representation. IEEE Transactions on Biomedical Engineering (IEEE TBME), 2023. [JCR-Q1类期刊]",
              "Libo Huang, Lu Gan, and Bingo Wing-Kuen Ling*. A unified optimization model of feature extraction and clustering for spike sorting. IEEE Transactions on Neural Systems and Rehabilitation Engineering (IEEE TNSRE), 2021. [JCR-Q1类期刊]",
              "Libo Huang, Xiangqi Li, Jiarui Zhao, Zhulin An*, et al. PrePrompt: predictive prompting for class incremental learning. SIGKDD Conference on Knowledge Discovery and Data Mining (KDD), 2026. [CCF-A类会议]",
              "Libo Huang, Yan Zeng, Chuanguang Yang, Zhulin An*, et al. eTag: Class-incremental learning via embedding distillation and task-oriented generation. AAAI Conference on Artificial Intelligence (AAAI), 2024. [CCF-A类会议]",
              ...
              "Libo Huang, Bingo Wing-Kuen Ling*, Yan Zeng, Lu Gan. Spike sorting based on low-rank and sparse representation. IEEE International Conference on Multimedia and Expo (ICME), 2020. [CCF-B类会议, oral]",
              "Libo Huang, Bingo Wing-Kuen Ling*, Ruichu Cai*, Yan Zeng, Jiong He, Yao Chen. WMsorting: Wavelet packets' decomposition and mutual information-based spike sorting method. IEEE Transactions on NanoBioscience (IEEE TNB), 2019. [JCR-Q1类期刊]",
              "Yao Chen, Libo Huang*, Jiong He, Kunyao Zhao, Ruichu Cai, Zhifeng Hao. HASS: High accuracy spike sorting with wavelet package decomposition and mutual information. IEEE International Conference on Bioinformatics and Biomedicine (BIBM), 2018. [CCF-B类会议, oral]",
              "Xiangqi Li#, Libo Huang#, Zhulin An*, et al. Geometric feature embedding for effective 3D few-shot class incremental learning. International Conference on Machine Learning (ICML), 2025. [CCF-A类会议]",
              "Jiarui Zhao, Libo Huang*, Xiangqi Li, Zhulin An*, et al. Representation-steered incremental adapter-tuning for class-incremental learning with pre-trained models, IEEE/CVF Conference on Computer Vision and Pattern Recognition (CVPR), 2026. [CCF-A类会议]",
              "Xiangqi Li, Libo Huang*, Jiarui Zhao, Weilun Feng, Chuanguang Yang, Zhulin An*, Yongjun Xu. Point-UQ: An uncertainty-quantification paradigm for point cloud few-shot class incremental learning. International Conference on Learning Representations (ICLR), 2026. [CCF-A类会议]",
              "Yanling Zhang, Wanhui Sun, Chuanguang Yang*, Libo Huang*, Zhulin An*, et al. TCMP-300: A comprehensive traditional Chinese medicinal plant dataset for plant recognition. Scientific Data, 2025. [Nature 子刊, JCR-Q1类期刊]",
              "Lve Huang, Xiaowei Yu, Huabiao Yan, Libo Huang*, et al. AF-YOLO: Asymptotic feature extraction and fusion for aerial object detection. IEEE Transactions on Circuits and Systems for Video Technology (IEEE TCSVT), 2025. [JCR-Q1类期刊]",
              ...
              "Haonan Mai, Libo Huang*, Zhulin An*, et al. OLN++: Improved object localization network for open-world object detection. IEEE International Conference on Acoustics, Speech and Signal Processing (ICASSP), 2025. [CCF-B类会议]",
              "Nan Yang, Libo Huang*, Zhulin An, Yongjun Xu, Xia Hong, Wing-Kuen Ling. Classification-based false alarm suppression for SAR target detection. IEEE International Symposium on Circuits and Systems (ISCAS), 2025. [CCF-B类会议]",
              "Yan Zeng, Ruichu Cai, Fuchun Sun*, Libo Huang, Zhifeng Hao. A survey on causal reinforcement learning. IEEE Transactions on Neural Networks and Learning Systems (IEEE TNNLS), 2024. [JCR-Q1类期刊]",
            ]
          },
          {
            "heading": "科研项目",
